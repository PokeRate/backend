...
def fetch_pokemon_abilities_and_create(auth_token, offset):
    """
    Fetch all Pokémon types from the PokeAPI and send them to the Django backend.
    """
    pokeapi_url = f"https://pokeapi.co/api/v2/ability/?limit=100000&offset={offset}"
    django_backend_url = "http://localhost:8000/api/pokemon/abilities/"
...
if __name__ == "__main__":
    ...
    fetch_pokemon_abilities_and_create(auth_token, offset)
